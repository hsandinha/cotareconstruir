...
function FornecedorDashboardContent() {
    ...
    const tourSteps: SupplierTourStep[] = [
        ...
        {
            requireTab: 'perfil',
            selector: '[data-tour="perfil-dados-empresa"]',
            title: 'Perfil • Dados da Empresa',
            description: 'Preencha Razão Social, CNPJ, Inscrição Estadual e Telefone Comercial. Ao sair do campo CNPJ, o sistema busca automaticamente os dados oficiais da Receita Federal — você só confere o que faltar.',
            placement: 'right',
        },
        {
            requireTab: 'perfil',
            selector: '[data-tour="perfil-contato"]',
            title: 'Perfil • Contato Gerencial',
            description: 'Cadastre o responsável comercial: nome, cargo, e-mail e WhatsApp. Esses contatos são exibidos aos clientes quando suas propostas são aprovadas — prefira gerentes ou diretores comerciais.',
            placement: 'left',
        },
        {
            requireTab: 'perfil',
            selector: '[data-tour="perfil-endereco"]',
            title: 'Perfil • Endereço',
            description: 'Digite o CEP e o endereço (logradouro, bairro, cidade e estado) é preenchido automaticamente. Complete só com número e complemento. Esse endereço aparece nas suas propostas.',
            placement: 'top',
        },
        {
            requireTab: 'perfil',
            selector: '[data-tour="perfil-regioes"]',
            title: 'Perfil • Regiões de Atendimento',
            description: 'Liste bairros, cidades ou estados que você atende, separados por vírgula (ex.: "Centro, Zona Sul, Belo Horizonte"). Cotações fora dessas regiões não aparecem para você.',
            placement: 'top',
        },
        {
            requireTab: 'perfil',
            selector: '[data-tour="perfil-grupos"]',
            title: 'Perfil • Grupos de Insumo',
            description: 'Marque os grupos de materiais que sua empresa fornece (Elétrica, Hidráulica, Acabamentos, etc.). Esses grupos definem quais cotações você recebe automaticamente. Clique em "Salvar Grupos" após escolher.',
            placement: 'top',
        },
        {
            requireTab: 'perfil',
            selector: '[data-tour="perfil-verificacao"]',
            title: 'Perfil • Verificação e Documentos',
            description: 'Expanda este bloco para enviar documentos da empresa (Contrato Social, CNPJ, certidões). Fornecedores verificados têm prioridade nas listagens e mais credibilidade junto aos clientes.',
            placement: 'top',
        },
        {
            requireTab: 'perfil',
            selector: '[data-tour="perfil-salvar"]',
            title: 'Perfil • Salvar Alterações',
            description: 'Sempre que mudar qualquer campo dos blocos acima, clique em "Salvar Alterações". O indicador "Perfil completo" no topo mostra quanto falta para chegar a 100%.',
            placement: 'left',
        },

        {
            ...
            description: 'Aqui você monta o catálogo do que sua empresa fornece, com preço e estoque. É a base para ser convidado em cotações relevantes.',
            placement: 'bottom',
        },
        {
            requireTab: 'materiais',
            selector: '[data-tour="materiais-acoes"]',
            title: 'Materiais • Importar / Exportar / Solicitar',
            description: '"Baixar Lista (CSV)" exporta seu catálogo atual. "Importar Lista (CSV/XLSX)" sobe vários materiais de uma vez (ideal para cadastros grandes). "Solicitar Novo Material" pede à equipe a inclusão de um item que ainda não existe na plataforma.',
            placement: 'bottom',
        },
        {
            requireTab: 'materiais',
            selector: '[data-tour="materiais-filtros"]',
            title: 'Materiais • Busca e filtros',
            description: 'Use a busca por nome, o filtro por Grupo (Elétrica, Hidráulica…) e o filtro de Status (Ativos, Pendentes, Inativos) para encontrar rapidamente o material que quer configurar.',
            placement: 'bottom',
        },
        {
            requireTab: 'materiais',
            selector: '[data-tour="materiais-tabela"]',
            title: 'Materiais • Tabela e configuração',
            description: 'Para cada material, defina Preço (R$), Estoque e clique para Editar. Materiais com preço configurado viram "Produtos" na aba "Minhas Ofertas". Você pode ordenar clicando nos cabeçalhos da tabela (Material, Preço, Estoque).',
            placement: 'top',
        },
        {
            requireTab: 'materiais',
...

        {
            ...
            description: 'Aqui aparecem somente os materiais que você já configurou com preço e estoque. É a sua "vitrine" para os clientes nas cotações.',
            placement: 'bottom',
        },
        {
            requireTab: 'ofertas',
            selector: '[data-tour="ofertas-busca"]',
            title: 'Ofertas • Buscar produto',
            description: 'Use a busca para localizar rapidamente um produto específico do seu catálogo de ofertas.',
            placement: 'bottom',
        },
        {
            requireTab: 'ofertas',
            selector: '[data-tour="ofertas-tabela"]',
            title: 'Ofertas • Preço e Quantidade Mínima',
            description: 'Cada linha mostra o produto, preço unitário e quantidade mínima de venda. Edite diretamente na tabela: o novo preço passa a ser usado como base ao responder cotações. Mantenha sempre atualizado para refletir custos atuais.',
            placement: 'top',
        },
        {
            requireTab: 'ofertas',
            title: 'Ofertas • Sem produtos?',
            description: 'Se a aba estiver vazia, é porque nenhum material foi configurado com preço. Volte em "Cadastro de Materiais", abra o material, defina preço e estoque, e ele aparecerá automaticamente aqui.',
            placement: 'center',
        },
        ...
        {
            requireTab: 'vendas-cotacoes',
            selector: '[data-tour="pedidos-cotacoes"]',
            title: 'Pedidos • Consultas de Preço (cotações recebidas)',
            description: 'Cada cotação mostra o cliente, a obra, os materiais pedidos e o prazo. Clique para abrir e responder com preço unitário, prazo de entrega e observações por item. Você pode anexar PDFs e usar o chat para tirar dúvidas com o cliente.',
            placement: 'top',
        },
        {
            requireTab: 'vendas-cotacoes',
            selector: '[data-tour="pedidos-confirmados"]',
            title: 'Pedidos • Pedidos Confirmados',
            description: 'Quando o cliente aprova sua proposta, ela vira um pedido confirmado e aparece neste bloco. Acompanhe o status (Confirmado → Em entrega → Entregue), confirme a entrega e libere a avaliação do cliente.',
            placement: 'top',
        },
        {
            requireTab: 'vendas-cotacoes',
        ...
        {
            requireTab: 'vendas-cotacoes',
            title: 'Pedidos • Notificações e relatórios',
            description: 'Você é notificado a cada novo pedido, mensagem no chat e mudança de status. Use os filtros (período, status, cliente) para revisar pedidos antigos, conferir vendas do mês e analisar sua performance comercial.',
            placement: 'center',
        },
